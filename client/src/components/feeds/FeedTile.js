          ...
          <div className="title">
            <nav role={"navigation"} className={"level"}>
              ...
              <div className={"level-left"}>
                <div className={"level-item"}><h1 className={"title"}> My Feed </h1></div>
              </div>

              <div className={"level-right"}>
                <div className={"level-item"}>
                  <a onClick={() => setActive(true)} className="button is-rounded is-primary">
        ...
        <div className="modal-content">
          {error.length > 0
            ? <article className="message is-small is-danger">
              <div className="message-header">
                <p>Empty Post!</p>
                <button onClick={() => setError("")} className="delete is-small" aria-label="delete"/>
              </div>
          ...
          <div className={"card"}>
            ...
            <div className={"card-content"}>
              ...
              <textarea value={message} onChange={updateMessage} className="textarea has-fixed-size"
            ...
            <footer className={"card-footer has-text-centered"}>
              <div className={"content"}>
                <a className="button is-primary"
                   style={{color: "#fff", marginLeft: "30px", marginTop: "10px", marginBottom: "10px"}}
                   onClick={() => {
                     post();
                   }}>Post</a>
              </div>
          ...
          <button onClick={() => setActive(!active)} className="modal-close is-large" aria-label="close"/>
        </div>
      </div>
    </div>
  )
